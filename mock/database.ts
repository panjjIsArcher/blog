...
export const projects: Project[] = [
    { name: "Celine1", subTitle: "这是Celine的AR", img: require("../public/image/lack.jpg"), url: mp4, id: 1 },
    { name: "Celine2", subTitle: "这是Celine的AR", img: require("../public/image/sky.jpg"), url: mp4, id: 2 },
    { name: "Celine3", subTitle: "这是Celine的AR", img: require("../public/image/avatar.jpg"), url: mp4, id: 3 },
    { name: "Celine4", subTitle: "这是Celine的AR", img: require("../public/image/sky.jpg"), url: mp4, id: 4 }
]